...
% Regla para la buusqueda de palabras claves
...
%Analizador de respuestas secundarios como destinos intermendios,
...
%-------------------------------------------------------------
% Reglas que busca palabras secundarias
% Tambien se encarga de hacer el arbol contoss
...
%Regla para buscar palabras claves.
